...
<a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown" href='{{route("testimony")}}' id="clientDropdown" role="button">
        CLIENT AREA
       </a>
...
<p>
     Explore the world's top performing stocks and markets with ease...
    </p>
</div>
</section>
...
<img alt="100x100" class="rounded-circle" data-holder-rendered="true" src="{{asset('static/testi/test1.jpg')}}" style="width: 50%;margin: auto;height: 170px;"/>
<i class="fas fa-quote-left" style="text-align: left;color: purple;">
</i>
<p class="card-text">
        Through in-depth discussion Jeremy encourages us to
...
<p class="card-text">
        INVESTOR IN BROADCAST DRIVE WASHINGTON
       </p>
</div>
</div>
<div class="col-md-5">
<div class="card card-body">
<img alt="100x100" class="rounded-circle" data-holder-rendered="true" src="{{asset('static/testi/test1m.jpg')}}" style="width: 50%;margin: auto;height: 170px;"/>
<i class="fas fa-quote-left" style="text-align: left;color: purple;">
</i>
<p class="card-text">
...
<p class="card-text">
        INVESTOR IN PRITCHARD COURT MEDFORD WASHINGTON
       </p>
</div>
</div>
<div class="col-md-1">
...
<div class="col-md-5">
<div class="card card-body">
<img alt="100x100" class="rounded-circle" data-holder-rendered="true" src="{{asset('static/testi/test2.jpg')}}" style="width: 50%;margin: auto;height: 170px;"/>
<i class="fas fa-quote-left" style="text-align: left;color: purple;">
</i>
<p class="card-text">
...
<p class="card-text">
        INVESTOR IN STREET CALGARY, AB
       </p>
</div>
</div>
<div class="col-md-5">
<div class="card card-body">
<img alt="100x100" class="rounded-circle" data-holder-rendered="true" src="{{asset('static/testi/test3.jpg')}}" style="width: 50%;margin: auto;height: 170px;"/>
<i class="fas fa-quote-left" style="text-align: left;color: purple;">
</i>
<p class="card-text">
...
<p class="card-text">
        INVESTOR IN CHIPMUNK LANE KINGFIELD
       </p>
</div>
</div>
<div class="col-md-1">
...
<div class="col-md-5">
<div class="card card-body">
<img alt="100x100" class="rounded-circle" data-holder-rendered="true" src="{{asset('static/testi/test3m.jpg')}}" style="width: 50%;margin: auto;height: 170px;"/>
<i class="fas fa-quote-left" style="text-align: left;color: purple;">
</i>
<p class="card-text">
        Good company to deal with , excellent customer service, fast payment.
                       It takes a lot to trust an investment firm in this climate but i am very happy with there services so far.
       </p>
<!-- <br> -->
<h3 class="card-text" style="font-weight: 600;">
        Brian S. Delgado
...
<p class="card-text">
        INVESTOR IN PROSPECT VALLEY ROAD GARDENA
       </p>
</div>
</div>
<div class="col-md-5">
<div class="card card-body">
<img alt="100x100" class="rounded-circle" data-holder-rendered="true" src="{{asset('static/testi/test4m.jpg')}}" style="width: 50%;margin: auto;height: 170px;"/>
<i class="fas fa-quote-left" style="text-align: left;color: purple;">
</i>
<p class="card-text">
...
<p class="card-text">
        INVESTOR IN CLOUSSON ROAD HOUSTON
       </p>
</div>
</div>
<div class="col-md-1">
...
<div class="col-md-5">
<div class="card card-body">
<img alt="100x100" class="rounded-circle" data-holder-rendered="true" src="{{asset('static/testi/test5.jpg')}}" style="width: 50%;margin: auto;height: 170px;"/>
<i class="fas fa-quote-left" style="text-align: left;color: purple;">
</i>
<p class="card-text">
        Your portfolio management is well planned and structured which made me
                      ...
                      of $5000 has grown to $16,500 profit and I've made over 50% within one month which has been equally shared,.
       </p>
<!-- <br> -->
<h3 class="card-text" style="font-weight: 600;">
        Hamish Wienholt
...
<p class="card-text">
        INVESTOR IN NEUER JUNGFERNSTIEG
       </p>
</div>
</div>
<div class="col-md-5">
<div class="card card-body">
<img alt="100x100" class="rounded-circle" data-holder-rendered="true" src="{{asset('static/testi/testf.jpg')}}" style="width: 50%;margin: auto;height: 170px;"/>
<i class="fas fa-quote-left" style="text-align: left;color: purple;">
</i>
<p class="card-text">
        I wish to thank you for this divine help because after two weeks
                      ...
                      we have been indebted to for over five months. We look to more profitable relationship with your firm. Thanks a million..
       </p>
<!-- <br> -->
<h3 class="card-text" style="font-weight: 600;">
        Francesca Boyle
...
<p class="card-text">
        INVESTOR IN PERNAJANTIE 40  KARJALOHJA
       </p>
</div>
</div>
<div class="col-md-1">
