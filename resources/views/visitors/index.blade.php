...
<link crossorigin="anonymous" href="{{asset('../maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css')}}" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" rel="stylesheet"/>
<title>
   globalbitfare : Home
  </title>
...
<a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown" href='{{route("index")}}' id="clientDropdown" role="button">
        CLIENT AREA
       </a>
...
<svg height="180" viewbox="0 0 290 180" width="290" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<defs>
...
<filter filterunits="objectBoundingBox" height="193%" id="prefix__d" width="193%" x="-46.5%" y="-30.2%">
...
<filter filterunits="objectBoundingBox" height="133.3%" id="prefix__h" width="119.7%" x="-9.8%" y="-16.7%">
...
<filter filterunits="objectBoundingBox" height="266.7%" id="prefix__m" width="266.7%" x="-83.3%" y="-54.2%">
<feoffset dy="14" in="SourceAlpha" result="shadowOffsetOuter1">
</feoffset>
<fegaussianblur in="shadowOffsetOuter1" result="shadowBlurOuter1" stddeviation="11">
</fegaussianblur>
...
<path d="M10.63.722v3.144C9.508 2.622 7.799.722 7.799.722H0v38.73L4.496 43l4.682-.586.036-3.432c1.537 1.266 3.645 2.993 3.645 2.993l7.67-.781V4.708L16.366.73 10.63.72z" fill="#231F20" mask="url(#prefix__g)">
</path>
</g>
<path d="M11.91 31.382l-.262.03L7.168 2.04l-5.97-.007L1.2 38.9s1.19-.17 3.707-.457l-.259-28.022.26-.024L9.17 38.006s1.457-.173 6.412-.664V2.037h-3.805l.133 29.345z" fill="#FEFEFE" transform="translate(30 26)">
</path>
</g>
</g>
<g mask="url(#prefix__e)">
<path d="M65.19 33.02c0-.133-.079-.176-.26-.176h-.175v.379l.175.004c.181 0 .26-.06.26-.185v-.022zm.273.94h-.207c-.02 0-.035-.012-.043-.028l-.283-.472c-.005-.01-.03-.021-.039-.021h-.127v.468c0 .025-.017.052-.05.052h-.188c-.023 0-.047-.027-.047-.052v-1.185c0-.069.027-.097.086-.106.066-.009.246-.015.343-.015.344 0 .552.1.552.42v.021c0 .198-.1.302-.254.353l.293.489c.002.01.008.023.008.035 0 .019-.011.04-.044.04zm-.492-1.573c-.51 0-.921.415-.921.915 0 .501.412.91.921.91.507 0 .923-.409.923-.91 0-.5-.416-.915-.923-.915zm0 2.013c-.619 0-1.113-.493-1.113-1.098 0-.603.494-1.098 1.113-1.098.613 0 1.116.495 1.116 1.098 0 .605-.503 1.098-1.116 1.098z" fill="#FFF" fill-rule="nonzero">
</path>
</g>
</g>
</g>
...
<path d="M33.469 10l-5.97 4.802 8.602 5.12-8.602 5.12 5.97 4.802L42 24.475l-5.899-4.553L42 15.369 33.469 10zm-11.938 0L13 15.37l5.899 4.552 8.6-5.12L21.531 10zM13 24.475l8.53 5.37 5.97-4.804-8.601-5.119L13 24.475zm8.53 6.388l-2.561-1.612v1.808L27.517 36l8.549-4.941V29.25l-2.562 1.612-5.987-4.788-5.986 4.788z" fill="#3183FF" transform="translate(199)">
</path>
</g>
</g>
</g>
...
<filter filterunits="objectBoundingBox" height="121.9%" id="prefix__c" width="120.2%" x="-10.1%" y="-10.6%">
...
<filter filterunits="objectBoundingBox" height="139.2%" id="prefix__k" width="139.2%" x="-19.6%" y="-18.8%">
...
<rect fill="#FFF" fill-opacity=".6" height="283.5" rx="7" stroke="#979797" stroke-opacity=".05" stroke-width=".5" width="307.5" x="13.75" y="-.25">
</rect>
</g>
<g>
...
<path d="M20.571 16.186L15 24l-5.571-7.814 5.57 3.36 5.572-3.36zM15 6l5.571 9.108L15 18.468l-5.571-3.36L15 6z" fill="#FFF">
</path>
<rect fill="url(#prefix__e)" height="30" rx="4" style="mix-blend-mode:overlay" width="30">
</rect>
</g>
<g>
<path d="M2 14.293L4.942 11.534 9.355 11.534 10.826 14.983 13.4 14.983 17.445 12.224 20.755 14.293 23.329 10.845 28.11 8.086 30.316 5.328 35.465 3.948 37.303 6.017 40.245 8.086 43.923 5.328 47.232 5.672 48.703 5.672 52.013 0.5 57.161 3.948 59 0.5 59 27.791 2 27.791z" fill="#F6FCEE" fill-opacity=".5" transform="translate(64 26) translate(14 10) translate(161 26)">
</path>
<path d="M2 14.786L4.942 11.929 9.355 11.929 10.826 15.5 13.4 15.5 17.445 12.643 20.755 14.786 23.329 11.214 28.11 8.357 30.316 5.5 35.465 4.071 37.303 6.214 40.245 8.357 43.923 5.5 47.232 5.857 48.703 5.857 52.013 0.5 57.161 4.071 59 0.5" stroke="#6BAD10" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" transform="translate(64 26) translate(14 10) translate(161 26)">
</path>
<path d="M22.375 -10.834L38.625 -10.834 38.625 50.166 22.375 50.166z" fill="url(#prefix__f)" transform="translate(64 26) translate(14 10) translate(161 26) rotate(-90 30.5 19.666)">
</path>
</g>
</g>
<path d="M85.014 49v-1.75h-3.637v-2.577h3.384v-1.736h-3.384v-2.195h3.637v-1.736h-5.756V49h5.756zm5.765 0v-8.23h2.714v-1.764h-7.547v1.764h2.714V49h2.12zm6.196 0v-4.313h3.958V49h2.113v-9.994h-2.113v3.917h-3.958v-3.917h-2.119V49h2.12z" fill="#2C2C2C" fill-rule="nonzero" transform="translate(64 26)">
</path>
<g>
...
<g>
<path d="M2 11.293L5 11.25 9 10 14 6.25 15 7.5 17.445 9.224 21 10 23.329 7.845 28.11 5.086 30 5 36 7.5 37.303 3.017 40.245 5.086 43.923 2.328 47.232 2.672 48.703 2.672 52 5 57.161 0.948 59 1.25 59 25 2 25z" fill="#FCECED" fill-opacity=".5" transform="translate(64 26) translate(14 60) translate(161 29) matrix(-1 0 0 1 61 0)">
</path>
<path d="M2 11.786L5 11.25 9 10 12 7.5 14 6.25 17.445 9.643 21 10 23.329 8.214 28.11 5.357 30 5 36 7.5 37.303 3.214 40.245 5.357 43.923 2.5 47.232 2.857 48.703 2.857 52 5 57.161 1.071 59 1.25" stroke="#D0021B" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" transform="translate(64 26) translate(14 60) translate(161 29) matrix(-1 0 0 1 61 0)">
</path>
<path d="M21.75 -13.209L39.25 -13.209 39.25 47.791 21.75 47.791z" fill="url(#prefix__j)" transform="translate(64 26) translate(14 60) translate(161 29) rotate(-90 30.5 17.291)">
</path>
</g>
</g>
<g>
...
<filter filterunits="objectBoundingBox" height="125.4%" id="prefix__d" width="126.5%" x="-13.3%" y="-12.3%">
<femorphology in="SourceAlpha" operator="dilate" radius="2" result="shadowSpreadOuter1">
</femorphology>
<feoffset dy="1" in="shadowSpreadOuter1" result="shadowOffsetOuter1">
</feoffset>
...
<filter filterunits="objectBoundingBox" height="125.4%" id="prefix__j" width="126.5%" x="-13.3%" y="-12.3%">
<femorphology in="SourceAlpha" operator="dilate" radius="2" result="shadowSpreadOuter1">
</femorphology>
<feoffset dy="1" in="shadowSpreadOuter1" result="shadowOffsetOuter1">
</feoffset>
...
<g>
<path d="M6.656 28.672L16.446 22.971 31.132 22.971 36.027 30.098 44.593 30.098 58.055 24.397 69.069 28.672 77.636 21.546 93.545 15.845 100.888 10.144 118.021 7.293 124.14 11.569 133.931 15.845 146.169 10.144 157.183 10.856 162.078 10.856 173.092 0.167 190.225 7.293 196.344 0.167 196.344 56.568 6.656 56.568z" fill="#F6FCEE" fill-opacity=".5" transform="translate(19 107)">
</path>
<path d="M6.656 29.69L16.446 23.786 31.132 23.786 36.027 31.167 44.593 31.167 58.055 25.262 69.069 29.69 77.636 22.31 93.545 16.405 100.888 10.5 118.021 7.548 124.14 11.976 133.931 16.405 146.169 10.5 157.183 11.238 162.078 11.238 173.092 0.167 190.225 7.548 196.344 0.167" stroke="#6BAD10" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" transform="translate(19 107)">
</path>
<path d="M84.708 -61.724L118.292 -61.724 118.292 141.276 84.708 141.276z" fill="url(#prefix__e)" transform="translate(19 107) rotate(-90 101.5 39.776)">
</path>
</g>
<g>
...
<path d="M82.571 72.137c1.532 0 2.707-.445 3.528-1.333.82-.889 1.23-2.16 1.23-3.815 0-1.659-.407-2.93-1.22-3.814-.814-.884-1.988-1.326-3.524-1.326s-2.715.438-3.538 1.316c-.822.877-1.234 2.147-1.234 3.81 0 1.664.41 2.94 1.23 3.829.821.888 1.997 1.333 3.528 1.333zm0-1.778c-.843 0-1.476-.282-1.9-.847-.424-.565-.636-1.406-.636-2.523 0-1.116.214-1.958.643-2.526.428-.567 1.064-.85 1.907-.85 1.682 0 2.522 1.125 2.522 3.376 0 2.247-.845 3.37-2.536 3.37zM91.345 72v-9.994h-2.12V72h2.12zm8.513 0v-1.75h-4.054v-8.244h-2.119V72h6.173z" fill="#393939" fill-rule="nonzero">
</path>
</g>
</g>
<g mask="url(#prefix__b)">
...
<path d="M12.1 0H25.85V1.65H12.1zM12.1 2.75H25.85V4.4H12.1zM12.1 5.5H25.85V7.15H12.1zM12.1 8.25H25.85V9.9H12.1zM0 11H25.85V12.65H0zM0 13.75H25.85V15.4H0zM0 16.5H25.85V18.15H0z" fill="#FE352E" fill-rule="nonzero" mask="url(#prefix__m)">
</path>
<path d="M0 0H12.1V9.9H0z" fill="#08399C" fill-rule="nonzero" mask="url(#prefix__m)">
</path>
<path d="M3.327 2.089L2.914 2.391 2.97 1.883 2.502 1.677 2.97 1.471 2.914 0.963 3.327 1.264 3.739 0.963 3.684 1.471 4.152 1.677 3.684 1.883 3.739 2.391z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 3.327 1.677)">
</path>
<path d="M3.327 5.389L2.914 5.691 2.97 5.183 2.502 4.977 2.97 4.771 2.914 4.263 3.327 4.564 3.739 4.263 3.684 4.771 4.152 4.977 3.684 5.183 3.739 5.691z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 3.327 4.977)">
</path>
<path d="M3.327 8.689L2.914 8.991 2.97 8.483 2.502 8.277 2.97 8.071 2.914 7.563 3.327 7.864 3.739 7.563 3.684 8.071 4.152 8.277 3.684 8.483 3.739 8.991z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 3.327 8.277)">
</path>
<path d="M6.627 2.089L6.214 2.391 6.27 1.883 5.802 1.677 6.27 1.471 6.214 0.963 6.627 1.264 7.039 0.963 6.984 1.471 7.452 1.677 6.984 1.883 7.039 2.391z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 6.627 1.677)">
</path>
<path d="M6.627 5.389L6.214 5.691 6.27 5.183 5.802 4.977 6.27 4.771 6.214 4.263 6.627 4.564 7.039 4.263 6.984 4.771 7.452 4.977 6.984 5.183 7.039 5.691z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 6.627 4.977)">
</path>
<path d="M9.927 5.389L9.514 5.691 9.57 5.183 9.102 4.977 9.57 4.771 9.514 4.263 9.927 4.564 10.339 4.263 10.284 4.771 10.752 4.977 10.284 5.183 10.339 5.691z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 9.927 4.977)">
</path>
<path d="M6.627 8.689L6.214 8.991 6.27 8.483 5.802 8.277 6.27 8.071 6.214 7.563 6.627 7.864 7.039 7.563 6.984 8.071 7.452 8.277 6.984 8.483 7.039 8.991z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 6.627 8.277)">
</path>
<path d="M9.927 2.089L9.514 2.391 9.57 1.883 9.102 1.677 9.57 1.471 9.514 0.963 9.927 1.264 10.339 0.963 10.284 1.471 10.752 1.677 10.284 1.883 10.339 2.391z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 9.927 1.677)">
</path>
<path d="M9.927 8.689L9.514 8.991 9.57 8.483 9.102 8.277 9.57 8.071 9.514 7.563 9.927 7.864 10.339 7.563 10.284 8.071 10.752 8.277 10.284 8.483 10.339 8.991z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 9.927 8.277)">
</path>
<path d="M1.677 3.739L1.264 4.041 1.32 3.533 0.852 3.327 1.32 3.121 1.264 2.612 1.677 2.914 2.089 2.612 2.034 3.121 2.502 3.327 2.034 3.533 2.089 4.041z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 1.677 3.327)">
</path>
<path d="M1.677 7.039L1.264 7.341 1.32 6.833 0.852 6.627 1.32 6.421 1.264 5.912 1.677 6.214 2.089 5.912 2.034 6.421 2.502 6.627 2.034 6.833 2.089 7.341z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 1.677 6.627)">
</path>
<path d="M4.977 3.739L4.564 4.041 4.62 3.533 4.152 3.327 4.62 3.121 4.564 2.612 4.977 2.914 5.389 2.612 5.334 3.121 5.802 3.327 5.334 3.533 5.389 4.041z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 4.977 3.327)">
</path>
<path d="M8.277 3.739L7.864 4.041 7.92 3.533 7.452 3.327 7.92 3.121 7.864 2.612 8.277 2.914 8.689 2.612 8.634 3.121 9.102 3.327 8.634 3.533 8.689 4.041z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 8.277 3.327)">
</path>
<path d="M4.977 7.039L4.564 7.341 4.62 6.833 4.152 6.627 4.62 6.421 4.564 5.912 4.977 6.214 5.389 5.912 5.334 6.421 5.802 6.627 5.334 6.833 5.389 7.341z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 4.977 6.627)">
</path>
<path d="M8.277 7.039L7.864 7.341 7.92 6.833 7.452 6.627 7.92 6.421 7.864 5.912 8.277 6.214 8.689 5.912 8.634 6.421 9.102 6.627 8.634 6.833 8.689 7.341z" fill="#FFF" mask="url(#prefix__m)" transform="rotate(30 8.277 6.627)">
</path>
...
<g>
<path d="M6.525 27.5L16.122 22.167 30.518 22.167 35.317 28.833 43.715 28.833 56.911 23.5 67.708 27.5 76.106 20.833 91.702 15.5 98.9 10.167 115.696 7.5 121.694 11.5 131.292 15.5 143.288 10.167 154.086 10.833 158.884 10.833 169.681 0.833 186.477 7.5 192.475 0.833 192.475 53.596 6.525 53.596z" fill="#F6FCEE" fill-opacity=".5" transform="translate(99 16) translate(18.5 69.5)">
</path>
<path d="M6.525 28.452L16.122 22.929 30.518 22.929 35.317 29.833 43.715 29.833 56.911 24.31 67.708 28.452 76.106 21.548 91.702 16.024 98.9 10.5 115.696 7.738 121.694 11.881 131.292 16.024 143.288 10.5 154.086 11.19 158.884 11.19 169.681 0.833 186.477 7.738 192.475 0.833" stroke="#6BAD10" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" transform="translate(99 16) translate(18.5 69.5)">
</path>
<path d="M83.792 -61.612L115.208 -61.612 115.208 137.388 83.792 137.388z" fill="url(#prefix__q)" transform="translate(99 16) translate(18.5 69.5) rotate(-90 99.5 37.888)">
</path>
</g>
...
<rect height="59.5" rx="3" stroke="#777" stroke-opacity=".5" stroke-width=".5" width="89.5" x=".25" y=".25">
</rect>
<path d="M0 0H90V24H0z" fill="#1A2D3D" fill-opacity=".9" mask="url(#prefix__s)">
</path>
<path d="M13.283 17c.969 0 1.736-.219 2.3-.656.564-.438.847-1.047.847-1.828 0-.551-.12-.993-.36-1.325-.24-.332-.633-.558-1.175-.68v-.058c.398-.066.717-.264.958-.592.24-.328.36-.748.36-1.26 0-.753-.275-1.303-.823-1.649-.55-.346-1.431-.518-2.646-.518h-2.666V17h3.205zm-.334-5.174h-1.054V9.922h.955c.52 0 .899.071 1.14.214.24.142.36.378.36.706 0 .351-.11.603-.331.756-.221.152-.578.228-1.07.228zm.13 3.674h-1.184v-2.232h1.125c1.015 0 1.523.355 1.523 1.066 0 .395-.12.687-.357.879-.239.191-.608.287-1.108.287zm8.334 1.617c.73 0 1.363-.127 1.898-.38.535-.255.944-.62 1.227-1.096.284-.477.425-1.032.425-1.664V8.434h-1.81v5.232c0 .664-.134 1.151-.402 1.462-.267.31-.698.466-1.292.466-.613 0-1.052-.155-1.318-.463-.266-.309-.398-.793-.398-1.453V8.434h-1.811v5.52c0 .98.305 1.752.914 2.317.61.564 1.465.846 2.567.846zM30.479 17v-3.334l2.842-5.232h-1.957l-1.787 3.527-1.775-3.527h-1.97l2.843 5.29V17h1.804z" fill="#FFF" fill-rule="nonzero" mask="url(#prefix__s)">
</path>
</g>
...
<script async="" src="{{asset('../s3.tradingview.com/external-embedding/embed-widget-symbol-info.js')}}" type="text/javascript">
        {
                  "symbol": "NASDAQ:TSLA",
                    "width": "100%",
                      "locale": "en",
...
<p>
       Secure assets and data encription
      </p>
</div>
<div class="col-md-4">
<i class="fas fa-lock">
...
<p>
       High privacy and and data privacy
      </p>
</div>
</div>
</div>
...
<a class="carousel-control-prev w-auto" data-slide="prev" href='{{route("index")}}' role="button">
...
<a class="carousel-control-next w-auto" data-slide="next" href='{{route("index")}}' role="button">
...
<h2>
       Trade with confidence on the world's leading friendly trading platform
      </h2>
<h6>
...
<div class="col-md-4">
<img alt="Responsive image" class="img-fluid float-start" src="{{asset('static/images/4.png')}}"/>
</div>
</div>
</div>
</section>
...
<div class="row">
<div class="col-md-6">
<img alt="Responsive image" class="img-fluid mx-auto d-block" src="{{asset('static/images/3.png')}}"/>
</div>
<div class="col-md-6">
<h2>
...
<img alt="First slide" class="d-block w-100" src="{{asset('static/images/17.jpg')}}" style="height: 500px;position: relative;"/>
<div class="testi">
<h3>
...
<img alt="Second slide" class="d-block w-100" src="{{asset('static/images/18.jpg')}}" style="height: 500px;position: relative;"/>
<div class="testi">
<h3>
        Meet Our Popular Investors
       </h3>
...
<div class="carousel-item">
<img alt="Third slide" class="d-block w-100" src="{{asset('static/images/19.jpg')}}" style="height: 500px;position: relative;"/>
<div class="testi">
<h3>
        Meet Our Popular Investors
       </h3>
...
<a class="carousel-control-prev" data-slide="prev" href='{{route("index")}}' role="button">
...
<a class="carousel-control-next" data-slide="next" href='{{route("index")}}' role="button">
...
<div class="col-md-5">
<img alt="Responsive image" class="img-fluid float-start" src="{{asset('static/images/5.png')}}"/>
</div>
<div class="col-md-4">
<h2>
