...
<a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown" href='{{route("faq")}}' id="clientDropdown" role="button">
        CLIENT AREA
       </a>
...
<div class="col-md-5">
<img alt="Responsive image" class="img-fluid mx-auto d-block" src="{{asset('static/images/13.svg')}}" style="height: 500px;"/>
</div>
</div>
</div>
</section>
